...
Source0  : https://files.pythonhosted.org/packages/26/bd/fdb26366443620f1a8a4d4ec7bfa37d1fbbe7bf737b257c205bbcf95ba95/meson_python-0.18.0.tar.gz
...
%prep
%setup -q -n meson_python-0.18.0
cd %{_builddir}/meson_python-0.18.0
pushd ..
cp -a meson_python-0.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746454784
