...
Source0  : https://files.pythonhosted.org/packages/1a/3f/b19e9354c358f5acf322dd1f81ed9f0c633ba4bcccfd32e9c3740c43c9e5/meson_python-0.16.0.tar.gz
...
%prep
%setup -q -n meson_python-0.16.0
cd %{_builddir}/meson_python-0.16.0
pushd ..
cp -a meson_python-0.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713366714
