...
Source0  : https://files.pythonhosted.org/packages/a2/3b/276b596824a0820987fdcc7721618453b4f9a8305fe20b611a00ac3f948e/meson_python-0.15.0.tar.gz
...
%prep
%setup -q -n meson_python-0.15.0
cd %{_builddir}/meson_python-0.15.0
pushd ..
cp -a meson_python-0.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708368386
...
/usr/share/package-licenses/pypi-meson_python/d35307a363044e8931785c522493cbde4429981a
